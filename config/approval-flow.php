...
return [
     ...
     * eg： "department"=> \Js3\ApprovalFlow\Generators\DepartmentApplicationImpl::class,
    ...
    "related-application" => [
        //仅供参考，正式使用时请屏蔽
        "demo-department"=> \Js3\ApprovalFlow\RelatedApplication\DepartmentApplicationImpl::class
    ]
];
